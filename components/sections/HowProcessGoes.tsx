        ...
        <div className='process-info'>
          ...
          <div id='process-step-1' className='process-step-block'>
            ...
            <ul className='simple-list'>
              ...
              <li>
                В личном кабинете вам будет доступна вся информация по обучению:
          ...
          <div id='process-step-2' className='process-step-block'>
            ...
            <ul className='simple-list'>
              <li>
                Вы проходите курсы последовательно и закрепляете полученные
                знания на специальных кейсах, тренажерах и тестированиях
              </li>
              <li>
                {at.online &&
          ...
          <div id='process-step-3' className='process-step-block'>
            ...
            <ul className='simple-list'>
              ...
              <li>
                ...
                внедренческих вебинарах, где разбираются итоги модуля и вопросы
                слушателей программы
              </li>
            </ul>
          </div>
          ...
          <div id='process-step-5' className='process-step-block'>
            ...
            <ul className='simple-list'>
              ...
              <li>По окончанию обучения вы получаете 2 престижных диплома</li>
            </ul>
          </div>
        </div>
      </div>
