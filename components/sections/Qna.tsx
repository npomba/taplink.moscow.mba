          ...
          <div className='faq-block'>
            ...
            <div className='faq-answer'>
              <p className={stls.mb}>
                ...
                поэтому даем возможность окончить программу досрочно. Вы можете
                сократить обучение на программе в два раза от полного срока
                обучения
              </p>
            </div>
          </div>
          <div className='faq-block'>
            ...
            <div className='faq-answer'>
              ...
              <p className={stls.mb}>
                ...
                программе, обратившись к куратору
              </p>
            </div>
          </div>
          <div className='faq-block'>
